...
def firebase_login_service(id_token, first_name='', last_name='', user_type='patnabor', agree_to_terms_and_conditions=False):
    try:
        ...
        if user:
            ...
            base_username = email.split('@')[0] if email else f"user_{str(uuid.uuid4())[:8]}" 
